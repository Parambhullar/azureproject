...
@dlt.table
def dimuser_stg():
    df = spark.read.table("workspace.silver.dimuser")
    return df
...
@dlt.table
def dimdate_stg():
    df = spark.read.table("workspace.silver.dimdate")
    return df
...
@dlt.table
def dimtrack_stg():
    df = spark.read.table("workspace.silver.dimtrack")
    return df
...
@dlt.table
def factstream_stg():
    df = spark.read.table("workspace.silver.factstream")
    return df
